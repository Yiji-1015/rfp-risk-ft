...
class EDARequirementsTests(unittest.TestCase):
    ...
    def test_analyze_dataset(self):
        ...
        self.assertEqual(res["type_counts"]["기능"], 2)
        self.assertEqual(res["type_counts"]["성능"], 1)
        
        # ID mismatch
        self.assertEqual(len(res["id_mismatches"]), 1)
        self.assertEqual(res["id_mismatches"][0]["requirement_id"], "REQ-002")
        self.assertEqual(res["id_mismatches"][0]["source_requirement_id"], "REQ--002")
    ...
    def test_generate_jupyter_notebook(self):
        ...
        self.assertTrue(len(nb_json["cells"]) >= 5)
