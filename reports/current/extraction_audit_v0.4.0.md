...
| supreme_court_sentencing | 0 | 155 | 0 | 0 | 0 | 목록 ID 없음 |
...
| knoc_genai_platform | 0 | 124 | 0 | 0 | 0 | 목록 ID 없음 |
| kdhc_plant_integrated_mgmt | 0 | 142 | 0 | 0 | 0 | 목록 ID 없음 |
...
- 본문 누락 UID: 없음
- 중복 UID: 없음
- ID 목록 없는 문서: kdhc_plant_integrated_mgmt, knoc_genai_platform, koen_ai_infrastructure, supreme_court_sentencing
